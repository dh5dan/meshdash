<script>
    $(function ($) {
        ...
        $("#infoImagePoint").on("click", function ()
        {
            ...
            outputMsg += '<b>--analog gpio 99</b> Pin setzen (default 32/T-Beam 25)<br>';
            outputMsg += '<b>--analog factor 99.9999</b> Faktor setzen (default 1.0)<br>';
            outputMsg += '<b>--analogcheck on/off</b> Berechnung on/off (default off)<br>';
            ...
            outputMsg += '<b>--nomsgall on/off</b> Opt-Out für „*“-Meldungen (an Alle)<br>zum Unterdrücken der eigenen Anzeige<br>';
            ...
            outputMsg += '<b>--setctry xx  [EU8, UK, US, VR2, 868, 915]</b> <span class="indented">setz die Landabhängigen LoRa-RX/TX-Parameter</span><span class="indented">siehe Tabelle (Auto.-Reboot nach 15 Sekunden)</span><br>';
            outputMsg += '<b>--setlat xx.xxxxxx</b> in ° setzen wenn kein GPS <span class="indented">vorhanden (Werte > 0 East)</span><br>';
            outputMsg += '<b>--setname xxxxxx</b> Wird mit der Position im Textfeld übertragen<br>';
            ...
            outputMsg += '<b>––setownip 255.255.255.255</b> WiFi IP-Adresse<br>';
            outputMsg += '<b>––setowngw  255.255.255.255</b> WiFi Gateway-Adresse<br>';
            outputMsg += '<b>––setownms  255.255.255.255</b> WiFi IP-Maske<br>';
