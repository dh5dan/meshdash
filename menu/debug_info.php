...
$checkTaskCmdUdpReceiver = getTaskCmd();
$taskResultUdpReceiver   = shell_exec($checkTaskCmdUdpReceiver); //Prüfe Hintergrundprozess
$statusImageUpdReceiver  = $taskResultUdpReceiver != '' ? 'punkt_green.png' : 'punkt_red.png';
...
echo '<td>';
echo '<img src="../image/'.$statusImageUpdReceiver.'" id="bgTask" class="cronStatusPoint" alt="statusColor">';
echo '</td>';
echo '</tr>';

echo '<tr>';
echo '<td>UDP-Receiver Task:</td>';
echo '<td>';
