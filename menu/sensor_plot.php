...
echo '<h2><span data-i18n="submenu.sensor_plot.lbl.header-text">Grafische Darstellung der Sensordaten</span></h2>';
...
echo '<tr>';
    ...
    echo '<td>';
        ...
        echo '<input type="date" name="sensorPlotTo" id="sensorPlotTo" />';
    echo'</td>';
echo '</tr>';
...
echo '<canvas id="sensorChart" width="0" height="100"></canvas>';
