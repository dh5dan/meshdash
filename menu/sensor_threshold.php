...
if ($sendData === '1')
{
    $resSaveSensorThresholdSetting = saveSensorThresholdSettings();
...
echo '<tr>';
echo '<td>Temp :</td>';
echo '<td><input type="checkbox" name="sensorThTempEnabled" ' . $sensorThTempEnabledChecked . ' id="sensorThTempEnabled" value="1" /></td>';
echo '</tr>';

echo '<tr>';
echo '<td>Temp min/max :</td>';
echo '<td>';
...
echo '<tr>';
echo '<td>DM-Gruppe: RX/TX Temp :</td>';
...
$sensorThToutDmGrpId  = $resGetThTempData['sensorThToutDmGrpId'];
...
echo '<tr>';
echo '<td>DM-Gruppe: RX/TX Tout :</td>';
...
$sensorThIna226vBusEnabled  = getParamData('sensorThIna226vBusEnabled');
$sensorThIna226vBusMinValue = getParamData('sensorThIna226vBusMinValue');
$sensorThIna226vBusMaxValue = getParamData('sensorThIna226vBusMaxValue');
$sensorThIna226vBusAlertMsg = getParamData('sensorThIna226vBusAlertMsg');
$sensorThIna226vBusDmGrpId  = getParamData('sensorThIna226vBusDmGrpId');
...
echo '<tr>';
echo '<td>Alertmeldung INA226-vBus :</td>';
...
echo '<tr>';
echo '<td>DM-Gruppe: RX/TX INA226-vBus :</td>';
...
$sensorThIna226vShuntEnabled  = getParamData('sensorThIna226vShuntEnabled');
$sensorThIna226vShuntMinValue = getParamData('sensorThIna226vShuntMinValue');
$sensorThIna226vShuntMaxValue = getParamData('sensorThIna226vShuntMaxValue');
$sensorThIna226vShuntAlertMsg = getParamData('sensorThIna226vShuntAlertMsg');
$sensorThIna226vShuntDmGrpId  = getParamData('sensorThIna226vShuntDmGrpId');
...
echo '<tr>';
echo '<td>INA226-vShunt min/max :</td>';
echo '<td>';
...
echo '<input type="text" name="sensorThIna226vShuntMaxValue" id="sensorThIna226vShuntMaxValue" value="' . $sensorThIna226vShuntMaxValue . '" placeholder="min. Wert" />';
echo '</td>';
echo '</tr>';

echo '<tr>';
echo '<td>Alertmeldung INA226-vShunt :</td>';
...
echo '<tr>';
echo '<td>DM-Gruppe: RX/TX INA226-vShunt :</td>';
...
$sensorThIna226vCurrentEnabled  = getParamData('sensorThIna226vCurrentEnabled');
$sensorThIna226vCurrentMinValue = getParamData('sensorThIna226vCurrentMinValue');
$sensorThIna226vCurrentMaxValue = getParamData('sensorThIna226vCurrentMaxValue');
$sensorThIna226vCurrentAlertMsg = getParamData('sensorThIna226vCurrentAlertMsg');
$sensorThIna226vCurrentDmGrpId  = getParamData('sensorThIna226vCurrentDmGrpId');
...
echo '<tr>';
echo '<td>INA226-vCurrent min/max :</td>';
echo '<td>';
...
echo '<tr>';
echo '<td>Alertmeldung INA226-vCurrent :</td>';
...
echo '<tr>';
echo '<td>DM-Gruppe: RX/TX INA226-vCurrent :</td>';
...
$sensorThIna226vPowerEnabled  = getParamData('sensorThIna226vPowerEnabled');
$sensorThIna226vPowerMinValue = getParamData('sensorThIna226vPowerMinValue');
$sensorThIna226vPowerMaxValue = getParamData('sensorThIna226vPowerMaxValue');
$sensorThIna226vPowerAlertMsg = getParamData('sensorThIna226vPowerAlertMsg');
$sensorThIna226vPowerDmGrpId  = getParamData('sensorThIna226vPowerDmGrpId');
...
echo '<tr>';
echo '<td>INA226-vPower min/max :</td>';
echo '<td>';
...
echo '<tr>';
echo '<td>Alertmeldung INA226-vPower :</td>';
...
echo '<tr>';
echo '<td>DM-Gruppe: RX/TX INA226-vPower :</td>';
...
echo '<tr>';
    echo '<td colspan="3"><input type="button" id="btnSaveSensorThreshold" value="Settings speichern"  /></td>';
echo '</tr>';
