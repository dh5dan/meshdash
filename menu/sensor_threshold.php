...
$sensorThTempIntervallSec = $resGetThTempData['sensorThTempIntervallSec'] ?? 60;

$sensorThTempEnabledChecked = $sensorThTempEnabled == 1 ? 'checked' : '';
$sensorThTempDmGrpId        = $sensorThTempDmGrpId == '' ? '999' : $sensorThTempDmGrpId;

$sensorThTempIntervallSec = $sensorThTempIntervallSec = '' ? 60 : $sensorThTempIntervallSec;
...
echo '<tr>';
echo '<td>Temp/Tout Check-Intervall:</td>';
echo '<td>';
echo '<input type="text" name="sensorThTempIntervallSec" id="sensorThTempIntervallSec" value="' . $sensorThTempIntervallSec . '" placeholder="Intervall Sek." />&nbsp;Sek.&nbsp;(>=60)';
echo'</td>';
echo '</tr>';
...
if ($hasIna226Sensor === true)
{
    ...
    $sensorThIna226IntervallSec = $resGetThIna226Data['sensorThIna226IntervallSec'] ?? 60;
    ...
    echo '<tr>';
    echo '<td>INA226 Check-Intervall:</td>';
    echo '<td>';
    echo '<input type="text" name="sensorThIna226IntervallSec" id="sensorThIna226IntervallSec" value="' . $sensorThIna226IntervallSec . '" placeholder="Intervall Sek." />&nbsp;Sek.&nbsp;(>=60)';
    echo'</td>';
    echo '</tr>';
